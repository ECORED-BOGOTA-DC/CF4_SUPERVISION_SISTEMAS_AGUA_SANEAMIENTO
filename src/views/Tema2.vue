...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure.mb-md-0.mb-4
      img(src="@/assets/curso/tema2/5.png" data-aos="zoom-in-up")
    .col-lg-10.m-auto
    ...
    .cont_2_3.mt-5.pb-5
      .col-lg-10.m-auto
        .row(style="background-color:#F6F6F6;border-radius:20px;box-shadow:rgba(0, 0, 0, 0.1) 0px 5px 9px 0px;position:relative;")
          .col-auto.p-0.d-flex.align-items-center
            figure
              img(src="@/assets/curso/tema2/15.png" data-aos="fade-right" style="margin-left: -47px;width: 100px;max-width: 100px;position:relative;")
          .col.p-0
            .p-4.ps-2
    ...
    .cont_gradiente1.mt-5
      ...
      figure.mt-4
        img(src="@/assets/curso/tema2/32.svg" data-aos="zoom-in-up")
