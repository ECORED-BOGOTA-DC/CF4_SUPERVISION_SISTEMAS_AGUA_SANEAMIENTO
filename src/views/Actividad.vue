  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conceptos relacionados con el suministro de agua
        p.mb-4 Identificar algunos conceptos básicos para determinar fuentes y estructuras de suministro de agua, según la normatividad vigente.
